...
//		iTween.ScaleTo (gameObject, iTween.Hash ("x", 1f, "y", 1f, "z", 1f, "time", 0.4f, "delay", 1.6f, "easeType", iTween.EaseType.easeInOutSine));
		...
		iTween.ScaleTo(gameObject, iTween.Hash("x", .75f, "y", .75f, "z", .75f, "time", 0.5f, "delay", 0.05f, "easeType", iTween.EaseType.easeInOutSine));
	...
	void Update () {
		localPosition += moveDirection * movementSpeed * Time.deltaTime;
